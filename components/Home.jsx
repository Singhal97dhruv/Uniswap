...
const Home = ({setActiveComponent,GET_POOL_DETAILS}) => {
  ...
  //Calling function
  const CALL_POOL_DETAILS=async(inputAddress)=>{
            ...
            <div className="flex justify-center">
              <div className="max-w-2xl">
                ...
                <p className="text-base text-default-200 font-medium px-5">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates quibusdam facilis reprehenderit dicta aliquam provident quo aut nam? Neque voluptates autem delectus ipsum ex consectetur, omnis odit accusamus temporibus recusandae?
                </p>
                <div className="backdrop-blur-2xl bg-white/10 rounded-md max-w-xl mx-auto">
                  <div className="w-full flex items-center justify-between mt-7">
                    ...
                    <button className="py-2 px-2 me-2 border-0 text-white font-semibold text-sm rounded-md backdrop-blur-2xl bg-primary hover:bg-primary-hover hover:text-white transition-all duration-500">

                    <div onClick={()=>CALL_POOL_DETAILS(poolAddress)} className="flex items-center justify-center gap-1">
                ...
                <div className="flex flex-wrap items-center justify-center gap-6 mt-10">
                  <a href="" onClick={(e)=>{
                    e.preventDefault()
                    setActiveComponent("Liquidity History")}} className="inline-flex items-center justify-center gap-2 bg-primary text-white py-2 px-6 rounded-full hover:bg-primary-hover transition-all duration-300">
                    {poolAddress? "Check Liquidity": "Get Pool Liquidity"}
                    <FaArrowRightLong/>
                  </a>
                  <a href="" onClick={(e)=>{
                    e.preventDefault()
                    setActiveComponent("Liquidity")}} className="inline-flex items-center justify-center gap-2 border border-white/10 text-white py-2 px-6 rounded-full hover:bg-primary-hover transition-all duration-300">
                    Liquidity
                    <FaArrowRightLong/>
                  </a>
                </div>
