          ...
          <div className="flex justify-center">
            <div className="max-w-2xl">
              ...
              <div className="flex flex-wrap items-center justify-center gap-6 mt-10">
                <a href="" onClick={()=>setActiveComponent("Home")} className="inline-flex items-center justify-center gap-2 bg-primary text-white py-2 px-6 rounded-full hover:bg-primary-hover transition-all duration-300">
                Get Pool Address
                  <FaArrowRightLong/>
                </a>
